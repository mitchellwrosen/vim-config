...
local function seems_like_haskell_project()
  ...
  if not or_250_ then
    ...
    local stop
    if git_root then
      stop = vim.fn.fnamemodify(git_root, ":h")
    else
      stop = nil
    end
    local found
